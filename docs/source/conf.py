...
# -*- coding: utf-8 -*-
#
# TexSoup documentation build configuration file, created by
...
version = 'master (' + TexSoup.__version__ + ' )'
...
man_pages = [
    (master_doc, 'TexSoup', 'TexSoup Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'TexSoup', 'TexSoup Documentation',
     author, 'TexSoup', 'One line description of project.',
     'Miscellaneous'),
]
