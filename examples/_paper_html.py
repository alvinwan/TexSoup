"""Rich HTML rendering helpers for the arXiv example."""
...
__all__ = ['PDF_PREVIEW_SUFFIX', 'render_paper_html']
...
def render_paper_html(tex, asset_root=None):
    r"""Render a TexSoup tree as a paper-style HTML document.

    :param TexNode tex: TexSoup node to render
    :param Union[str,Path,None] asset_root:
        root directory used to resolve local figure assets
    :return: rendered HTML document
    :rtype: str

    >>> from TexSoup import TexSoup
    >>> render_paper_html(TexSoup(r'\section{Hello}')).startswith('<!DOCTYPE html>')
    True
    """
